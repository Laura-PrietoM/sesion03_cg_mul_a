...
public class Cartesiana {
    ...
    public Cartesiana polar_cartesiano(float radio, float angulo) {//Conversión de polares a cartesianas
        float x = radio * (float)Math.cos(angulo);
        float y = radio * (float)Math.sin(angulo);
        return new Cartesiana(x, y);
    }
    
    public Cartesiana polar_cartesiano (Polar p){ //Conversión de polares a cartesianas
     ...
     public Polar cartesiano_polar(float x, float y){//Conversión de  cartesianas a polares
      ...
      public Polar cartesiano_polar (Cartesiana c){ //Conversión de  cartesianas a polares
